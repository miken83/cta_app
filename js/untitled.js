function getAlertStatus(){
	...
	$('.route').click(function(){
		...
		$('.status').html("<h1>" + xmldoc.getElementsByTagName("RouteInfo")[0].childNodes['0'].textContent + "</h1><h3>" + xmldoc.getElementsByTagName("RouteStatus")[0].childNodes['0'].textContent + "</h3>");
	});
